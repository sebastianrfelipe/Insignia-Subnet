...
The report summarizes a 6-metric headline allocation, but the repository keeps an 8-metric trading scorer for risk controls, plus win rate as an unweighted diagnostic. The `model_attribution` metric was removed when pairing became genetic-algorithm-assigned (a miner cannot influence which model it is paired with), and its weight was redistributed. On 2026-08-03 absolute `realized_pnl` was replaced by scale-invariant `annualized_return`, `win_rate` was demoted to the diagnostics tier, and the surviving weights were renormalized pro-rata (x 1/0.94). The checked-in defaults are:

- annualized_return: 0.2128
- omega: 0.1383
- max_drawdown: 0.1489
- consistency: 0.2128
- execution_quality: 0.1064
- annualized_volatility: 0.0532
- sharpe_ratio: 0.0638
- sortino_ratio: 0.0638

Diagnostics tier (reported, unweighted): win_rate.
