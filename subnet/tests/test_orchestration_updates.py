...
class SimulationResult:
    ...
    honest_researcher_scores: list = field(default_factory=list)
    adversarial_researcher_scores: list = field(default_factory=list)
    trader_scores: dict = field(default_factory=dict)
    trader_types: dict = field(default_factory=dict)
    honest_trader_scores: list = field(default_factory=list)
    adversarial_trader_scores: list = field(default_factory=list)
