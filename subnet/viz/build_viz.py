...
from viz import build_input_data, build_model_perf, build_scoring
...
def main() -> None:
    ...
    if cached:
        pipe, model_info = cached
    else:
        pipe, model_info = train_and_save(df, feature_cols)
    ...
    build_scoring.build(pipe, model_info)
