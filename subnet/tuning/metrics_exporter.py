...
TRADER_ANNUALIZED_RETURN = REGISTRY.gauge("insignia_trader_annualized_return", "Trader miner strategy annualized return (365-day basis)")
TRADER_PNL = REGISTRY.gauge("insignia_trader_realized_pnl", "Trader miner strategy realized P&L (diagnostic only — not composite-weighted)")
